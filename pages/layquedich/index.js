...
export default function IndexLayQueDich() {
  ...
  function ngayphuc(lunar, solarDay, solarMonth, solarYear) {
    var s;
    var dayOfWeek = TUAN[(lunar.jd + 1) % 7];
    s = dayOfWeek + " " + solarDay + "/" + solarMonth + "/" + solarYear;
    s += " -+- ";
  ...
  function thangphuc(lunar, solarDay, solarMonth, solarYear) {
    var s;
    var dayOfWeek = TUAN[(lunar.jd + 1) % 7];
    s = dayOfWeek + " " + solarDay + "/" + solarMonth + "/" + solarYear;
    s += " -+- ";
  ...
  // function namphuc(){
  // 	console.log(getYearCanChi(currentLunarDate.year))
  // }
  ...
  let tinhSoNamQue = () => {};
  let queTrongNgay = () => {
    let ngay = ngayphuc(currentLunarDate);
    let thang = thangphuc(currentLunarDate);
  ...
  return (
    <Layout className="container">
      <div className="rounded bg-orange-300  h-500 w-500 ">
        <p className="text-center">Hôm nay ngày : {getTodayString()}</p>
        {queTrongNgay()}
      </div>
